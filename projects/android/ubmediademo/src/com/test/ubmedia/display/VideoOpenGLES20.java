...
public class VideoOpenGLES20 extends GLSurfaceView
    ...
    public static boolean UseOpenGL2(Object renderWindow) {
        return VideoOpenGLES20.class.isInstance(renderWindow);
    }

    public VideoOpenGLES20(Context context) {
        super(context);
        init(false, 0, 0);
    }

    public VideoOpenGLES20(Context context, boolean translucent,
